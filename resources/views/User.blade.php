...
<article>
    <h2>Formulaire</h2>
<a href="{{route('Adduser')}}" class="btn btn-primary">create</a>
    ...
    <table class="vitamins">
        ...
        <tbody>
           ...
           <td>{{$item->age}}</td> 
            ...
            <td>
            <a href="{{route('edituser',$item->id)}}" class="text-success">Edit</a>
                <a href="{{route('destroyuser',$item->id)}}" class="text-danger">Delete</a>
            </td>
            </tr>
            @endforeach
