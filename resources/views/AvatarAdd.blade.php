...
<div class="container">
      ...
      <form name="register" action="{{route('saveavatar')}}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row pt-5">
            <div class="col-xs-6">
              <div class="form-group">
                ...
                <input autofocus="autofocus" class="form-control" required="required" type="text" name="nom" id="nom">
